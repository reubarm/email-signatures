...
var validRoles = ['adjustable', 'button', 'header', 'image', 'imagebutton', 'keyboardKey', 'link', 'none', 'search', 'summary', 'text'];
...
function queryAllByRole(container, value) {
  var _ref = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
      ...
      filter = _ref$filter === void 0 ? function (n) {
    return n;
  } : _ref$filter;
  ...
  return [].concat((0, _toConsumableArray2.default)(roleElements), (0, _toConsumableArray2.default)(traitElements)).filter(filter).filter(function (node) {
