...
exports.Wrapper = exports.ReactPhoneInputWrapper = void 0;
const theme_1 = __importDefault(require("../../../theme"));
const flagsWidth = 60;
const transparentWhite = 'rgba(256, 256, 256, 0)';
exports.ReactPhoneInputWrapper = theme_1.default.div `
  width: 100%;
...
`;
exports.Wrapper = theme_1.default.div `
  width: 100%;
  ...
  .react-tel-input {
    ...
    var _a;
    return p.isError
        ? (_a = p.theme.context.colors.input) === null || _a === void 0 ? void 0 : _a.background.error : 'rgb(247, 248, 252)';
}};
  }
  .react-tel-input .form-control {
    border: none;
    ...
    var _a;
    return p.isError
        ? (_a = p.theme.context.colors.input) === null || _a === void 0 ? void 0 : _a.border.error : 'rgb(150, 153, 170)';
}}
      0px -2px 0px 0px inset;
  }
...
`;
//# sourceMappingURL=PhoneInput.styles.js.map