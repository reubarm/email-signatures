...
const equalsContext = {
    input: {
        background: {
            ...
            complete: geometry_palette_1.colorPalette.skyBlue[0],
            disabled: geometry_palette_1.colorPalette.grey[1],
        },
        border: {
            default: geometry_palette_1.colorPalette.grey[5],
            focused: geometry_palette_1.colorPalette.mango[0],
            error: geometry_palette_1.colorPalette.red[1],
            complete: geometry_palette_1.colorPalette.skyBlue[7],
        },
        label: {
    ...
    actions: {
        border: {
            ...
            secondary: {
                default: geometry_palette_1.colorPalette.midnightBlue[0],
                hover: geometry_palette_1.colorPalette.mango[0],
                focused: geometry_palette_1.colorPalette.mango[0],
                error: '',
                complete: '',
        ...
        background: {
            primary: {
                default: geometry_palette_1.colorPalette.mango[0],
                focused: geometry_palette_1.colorPalette.skyBlue[5],
                disabled: geometry_palette_1.colorPalette.grey[2],
                loading: geometry_palette_1.colorPalette.grey[2],
                error: '',
                complete: '',
                hover: geometry_palette_1.colorPalette.mango[1],
            },
            tertiary: {
                default: 'transparent',
                focused: '',
        ...
        foreground: {
            primary: {
                default: geometry_palette_1.colorPalette.midnightBlue[0],
                hover: geometry_palette_1.colorPalette.midnightBlue[0],
                focused: '',
                error: '',
                complete: '',
    ...
    spinner: Spinner_context_1.spinnerEquals,
    navigation: {
        sidebar: SideBarNavigation_context_1.sideBarNavigationEquals,
    },
};
exports.equalsTheme = Object.assign(Object.assign({}, tokens_1.tokens), { palette: geometry_palette_1.colorPalette, context: {
        colors: equalsContext,
    } });
//# sourceMappingURL=context.equals.js.map